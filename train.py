...
def main():
    ...
    parser.add_argument("--exp-name", type=str, default="train")
    parser.add_argument(
    ...
    parser.add_argument("--save-freq", type=int, default=30)
    ...
    # Todo: Define loss for SimCLR
    criterion = None
    assert criterion is not None, "Define your loss"
